...
var ItemDAOImpl = /** @class */ (function () {
    ...
    ItemDAOImpl.prototype.update = function (entity) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.connection.query("UPDATE item SET description='" + entity.description + "','" + entity.unitPrice + "','" + entity.qtyOnHand + "' WHERE itemcode='" + entity.code + "'", function (err, results) {
                if (err) {
                    reject(err);
                }
                else {
